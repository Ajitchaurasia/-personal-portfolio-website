...
copy.addEventListener("click", () => {
  navigator.clipboard.writeText("ajitchaurasia9631@gmail.com");
...
/*SCROLL CONTACT*/
  // sr.reveal(".contact-input", { interval: 200 });
    ...
    var messageArr = [ "WEB Developer & UI and UX Design"];
  var textPosition = 0;
  var speed = 200;
...
function updateYear() {
  ...
  // Add an event listener to run the updateYear function when the DOM is ready
